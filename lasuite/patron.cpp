...
//  DATE      :
//  OBJET     :
//  AUTEUR(S) : Béranger RINCENT Alexis MARINHO
//***************************************************************************
...
int main(void)
{
    ...
    while(nbLibres < nbCases - nbMines) {
        do {
            ...
            cout << '\t' << "(4) jouer toutes les cases à partir d'une case de départ et d'une direction" << endl;
        ...
        // retour au système d'exploitattion
    }
    cout << "c'est gagné !" << endl << "bah t'a gagné quoi ?";
}
// ============================ Fin du programme ============================ //
